                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.events.update', $event->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title', $event->title) }}" required class="form-control">
                            </div>

                            <div class="mb-3">
                                <label for="description" class="form-label">Description</label>
                                <textarea name="description" id="description" required class="form-control" rows="4">{{ old('description', $event->description) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    @foreach (json_decode($event->image, true) ?? [] as $img)
                                        <div class="col-md-3">
